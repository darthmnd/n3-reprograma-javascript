...
// const gatos = [navi, quico, chiquinha]
...
// function arrayParaObjeto(arrCarro){
//   let obj = {};
//   for (let i of arr){
//     obj[i[0]] = i[1]
//   }
...
function findPokemonType(){
  const pokemonMap = POKEMON.map(function pokemonLocate(type, name){
  
  for(let pokemonType in POKEMON){
